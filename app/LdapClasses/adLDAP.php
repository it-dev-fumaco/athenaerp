...
class adLDAP
{
    ...
    public function __construct($options = [])
    {
        ...
        if (count($options) > 0) {
            if (Arr::has($options, 'account_suffix')) {
                $this->accountSuffix = $options['account_suffix'];
            }
            if (Arr::has($options, 'base_dn')) {
