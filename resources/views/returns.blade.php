	...
	<div class="content-header pt-0">
		<div class="container-fluid">
			{{-- <div class="row mb-0">
				<div class="col-sm-6">
					<h2><a href="/" class="btn btn-default float-left pt-2 pb-2 pr-3 pl-3 mr-2 ">
					  ...
					  </a>Returns <small>Incoming</small></h2>
				</div>
				<div class="col-sm-1">
			...
			<div class="row">
					...
					<div class="card card-primary card-outline">
						<div class="card-header p-0 pt-1 border-bottom-0">
							<div class="row">
								...
								<div class="col-xl-2">
									<div class="text-center m-1 d-none" id="total-result-internal-return">
									   <span class="font-weight-bold">TOTAL RESULT:</span>
									   <span class="badge bg-info" style="font-size: 12pt;">@{{ return_filtered.length }}</span>
									</div>

									<div class="text-center m-1 d-none" id="total-result-sales-return">
										<span class="font-weight-bold">TOTAL RESULT:</span>
                ...
                <li class="nav-item">
                  <a class="nav-link active font-weight-bold" id="internal-return-tab" data-toggle="pill" href="#custom-tabs-three-2" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Internal Return</a>
				</li>
				<li class="nav-item">
					<a class="nav-link font-weight-bold" id="sales-return-tab" data-toggle="pill" href="#custom-tabs-three-3" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Sales Return</a>
				</li>
              </ul>
						</div>
						<div class="card-body p-0">
							<div class="tab-content" id="custom-tabs-three-tabContent">
								...
								<div class="tab-pane show active fade" id="custom-tabs-three-2" role="tabpanel" aria-labelledby="internal-return-tab">
									<div class="row m-0 p-0">
								...
								<div class="tab-pane fade" id="custom-tabs-three-3" role="tabpanel" aria-labelledby="sales-return-tab">
									<div class="row m-0 p-0">
									  <div class="col-md-4 offset-md-8 p-1" style="margin-top: -40px;">
										{{-- <div class="text-right">
										  <span class="font-weight-bold">TOTAL RESULT:</span>
