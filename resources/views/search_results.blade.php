							...
							<div class="card-header p-0">
								...
								{{-- <div id="accordion" class="col-12 p-0">
									<div class="card m-0">
										<div class="row">
											<div class="col-8">
												<button class="btn text-left d-inline pt-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
											...
											<div class="card-body p-0">
												<div class="col-10 mx-auto">
													<div class="row">
														...
														<div class="col-4">
															<div class="form-group m-0 w-100" id="warehouse-filter-parent" style="font-size: 11pt;">
																<select name="warehouse" id="warehouse-filter" class="form-control">
