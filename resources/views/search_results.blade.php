										...
										<table class="table table-sm table-bordered">
											...
											@forelse($row['item_inventory'] as $inv)
												<tr>
													...
													<td class="text-center"><span class="badge badge-{{ ($inv['available_qty'] > 0) ? 'success' : 'danger' }}" style="font-size: 12px; margin: 0 auto;">{{ $inv['available_qty'] * 1 . ' ' . $inv['stock_uom'] }}</span></td>
												</tr>
											@empty
												<tr>
