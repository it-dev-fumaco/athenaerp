                        ...
                        <div class="card-body p-1">
                            <div class="container">
                                ...
                                <div class="tab-content"> 
                                    <div id="beginning_inventory" class="container tab-pane active" style="padding: 8px 0 0 0;">
                                        <div class="container-fluid">
                                                                            ...
                                                                            <table class="table table-bordered">
                                                                                ...
                                                                                @forelse ($inv['items'] as $item)
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center" style="font-size: 10pt"><input type="text" value="₱{{ number_format($item['price'], 2) }}" style="text-align: center; width: 80px;" /></td>
                                                                                    </tr>
                                                                                @empty
                                                                                    <tr>
