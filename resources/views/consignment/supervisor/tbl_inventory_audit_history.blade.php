    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center font-responsive align-middle p-2">
                <a href="/view_inventory_audit_items/{{ $row->branch_warehouse }}/{{ $row->cutoff_period_from }}/{{ $row->cutoff_period_to }}" class="btn btn-info btn-sm" style="width: 70px;"><i class="fas fa-search"></i></a>
            </td>
        </tr>
        @empty
        <tr>
