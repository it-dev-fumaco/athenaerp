                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body add-item-modal">
                                                                                        <select name="" id="" class="replacement-item form-control" data-name="{{ $inv['name'] }}"></select>
                                                                                        <div id="{{ $inv['name'] }}-new-item-container" class="pt-2 d-nonex">
                                                                                            <table class="table table-striped new-item-table">
                                                                                                <thead>
                                                                                                    <th class="font-responsive text-center p-1 align-middle" style="width: 34%">Item Code</th>
                                                                                                    <th class="font-responsive text-center p-1 align-middle" style="width: 34%">Opening Stock</th>
                                                                                                    <th class="font-responsive text-center p-1 align-middle" style="width: 32%">Price</th>
                                                                                                </thead>
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td class="text-justify p-1 align-middle" colspan="3">
                                                                                                            <div class="d-flex flex-row justify-content-center align-items-center">
                                                                                                                <div class="p-1 col-2 text-center">
                                                                                                                    <div class="d-none">
                                                                                                                        <span id="{{ $inv['name'] }}-webp-display"></span>
                                                                                                                        <span id="{{ $inv['name'] }}-img-display"></span>
                                                                                                                        <span id="{{ $inv['name'] }}-alt-display"></span>
                                                                                                                        <span id="{{ $inv['name'] }}-max-display"></span>
                                                                                                                    </div>
                                                                                                                    <picture>
                                                                                                                        <source srcset="" id="{{ $inv['name'] }}-new-src-img-webp" type="image/webp">
                                                                                                                        <source srcset="" id="{{ $inv['name'] }}-new-src-img" type="image/jpeg">
                                                                                                                        <img src="" alt="" id="{{ $inv['name'] }}-new-img" class="img-thumbna1il" alt="User Image" width="40" height="40">
                                                                                                                    </picture>
                                                                                                                </div>
                                                                                                                <div class="p-1 col m-0">
                                                                                                                    <span class="font-weight-bold font-responsive"><span id="{{ $inv['name'] }}-item-code-display"></span></span>
                                                                                                                </div>
                                                                                                                <div class="p-0 col-4">
                                                                                                                    <div class="input-group p-1">
                                                                                                                        ...
                                                                                                                        <div class="custom-a p-0">
                                                                                                                            <input type="text" class="form-control form-control-sm qty new-item-validate new-item-stock" id="{{ $inv['name'] }}-new-item-stock" value="0" style="text-align: center; width: 47px">
                                                                                                                        </div>
                                                                                                                ...
                                                                                                                <div class="col-3 text-center">
                                                                                                                    <input type="number" min='0' id="{{ $inv['name'] }}-new-item-price" class="form-control">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="p-1" id="{{ $inv['name'] }}-description-display" style="font-size: 9.5pt !important;"></div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
