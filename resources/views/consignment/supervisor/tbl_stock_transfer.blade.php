                                                ...
                                                <div class="col-8 offset-2">
                                                    <div class="callout callout-warning text-center mt-2">
                                                        @php
                                                            ...
                                                            $stockEntryUrl = $erpWebBaseUrl ? $erpWebBaseUrl.'/app/stock-entry/'.$stockEntry->name : null;
                                                        @endphp
                                                        <i class="fas fa-info-circle"></i> A <b>DRAFT</b> Stock Entry has been created. <br> To submit the stock entry, please login to ERP and click <a class="text-dark" target="_blank" href="{{ $stockEntryUrl }}">here</a>.
