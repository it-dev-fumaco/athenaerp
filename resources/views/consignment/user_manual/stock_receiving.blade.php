                    ...
                    <div class="card card-info card-outline" style="font-size: 9pt;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_1.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_2.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_3.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2 text-justify">3. Click on the name of the store to review and confirm the items to be received.</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_4.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2 text-justify">4. After confirming the quantity received per item. Click "<b>Receive</b>".</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_5.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="alert alert-info p-2 text-justify" style="font-size: 9pt;">
                                <i class="fas fa-info-circle"></i> <b>Note:</b> You can also enter/update the price of an item by editing the rate.
                            </div>
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_6.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="alert alert-info p-2 text-justify" style="font-size: 9pt;">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_7.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/stock_receiving_8.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
