                    ...
                    <div class="card card-info card-outline" style="font-size: 9pt;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_2.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_3.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_4.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="alert alert-info p-2" style="font-size: 9pt;">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_5.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_6.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2 text-justify">iii. That item will be added to the list.</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_7.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_8.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_9.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_10.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_11.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_12.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('storage/user_manual_img/cs_13.png') }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                        </div>
                    </div>
                </div>
