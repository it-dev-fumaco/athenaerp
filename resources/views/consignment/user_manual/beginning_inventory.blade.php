                    ...
                    <div class="card card-info card-outline" style="font-size: 9pt;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_1']) ? $images['beginning_inventory_1'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2 text-justify">2. You will see a list of beginning inventory entries, if any. Click "<b>Create</b>".</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_2']) ? $images['beginning_inventory_2'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_3']) ? $images['beginning_inventory_3'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_4']) ? $images['beginning_inventory_4'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2 text-justify">5. You can then enter the qty of items and their price.</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_5']) ? $images['beginning_inventory_5'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_6']) ? $images['beginning_inventory_6'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                                <img src="{{ isset($images['beginning_inventory_7']) ? $images['beginning_inventory_7'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_8']) ? $images['beginning_inventory_8'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>        
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_9']) ? $images['beginning_inventory_9'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_10']) ? $images['beginning_inventory_10'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_11']) ? $images['beginning_inventory_11'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2">Edit any input and click "<b>Update</b>"</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_12']) ? $images['beginning_inventory_12'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="alert alert-info p-2" style="font-size: 9pt;">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_13']) ? $images['beginning_inventory_13'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <p class="mt-2 mb-2">Click "<b>Cancel</b>".</p>
                            <div class="d-flex justify-content-center">
                                <img src="{{ isset($images['beginning_inventory_14']) ? $images['beginning_inventory_14'] : $images['no_img'] }}" style="width: 70%; margin-bottom: 30px;">
                            </div>
                            <div class="alert alert-info p-2" style="font-size: 9pt;">
