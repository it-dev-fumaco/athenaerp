                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <div class="d-block d-lg-none">
                                                <span class="badge badge-{{ $badge }}">{{ $status }}</span><br><br>
                                                <a href="#" data-toggle="modal" data-target="#{{ $ste['name'] }}-Modal2">
                                                    View items
                                                </a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer {{ $ste['docstatus'] == 1 ? 'd-none' : null }}">
                                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#cancel-{{ $ste['name'] }}-Modal2">
                                                                    Cancel
                                                                </button>
                                                                  
                                                                  <!-- Modal -->
                                                                <div class="modal fade" id="cancel-{{ $ste['name'] }}-Modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header" style="background-color: #001F3F; color: #fff">
                                                                                <span class="modal-title" id="exampleModalLabel">{{ $ste['name'] }}</span>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true" style="#fff;">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                        ...
                                        <td>
                                            ...
                                            <div class="d-inline d-lg-none text-left">
                                                <b>From: </b>{{ $ste['from_warehouse'] }} <br><br>
                                                <b>To: </b>{{ $ste['to_warehouse'] == 'Quarantine Warehouse P2 - FI' ? 'Fumaco - Plant 2' : $ste['to_warehouse'] }}
                                            </div>
                                        </td>
                                        <td class="text-center d-none d-lg-table-cell">{{ $ste['to_warehouse'] == 'Quarantine Warehouse P2 - FI' ? 'Fumaco - Plant 2' : $ste['to_warehouse'] }}</td>
