            ...
            <div class="info-box bg-gradient-secondary m-0">
              <div class="info-box-content p-0">
                <div class="d-flex flex-row p-0 m-0 align-items-center justify-content-around">
                  ...
                  <div class="p-1 text-center" style="font-size: 9pt;">Consignment Order <span class="d-block" style="font-size: 7pt;">Pending: {{ number_format($total_stock_adjustments) }}</span></div>
                </div>
              </div>
            </div>
          </a>
