                  ...
                  <div class="card-header text-center">
                     <span id="branch-name" class="font-weight-bold d-block font-responsive">{{ $branch }}</span>
						...
						<div class="card-body p-2">
							@if ($due_alert)
							<div class="alert alert-warning font-responsive text-center pr-1 pl-1 pb-3 pt-3 m-0"><i class="fas fa-info-circle"></i> Sales report submission is due tomorrow</div>
							@endif
