                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-4 mt-3">
                                    <a href="{{ $q['img'] }}" data-toggle="lightbox" data-gallery="{{ $q['item_code'] }}" data-title="{{ $q['item_code'] }}">
                                        <img class="display-block img-thumbnail" src="{{ $q['img'] }}" style="width: 100%;" class="item_image">
                                    </a>
                                </div>
