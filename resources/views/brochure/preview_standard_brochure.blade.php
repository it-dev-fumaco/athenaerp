                                    ...
                                    <div style="width: 43%; float: left; padding: 2px !important;">
                                        ...
                                        <div class="img-cont {{ $img1Actual }}" style="margin-bottom: 20px !important;" id="item-01-actual">
                                            ...
                                            <div class="custom-hover-button">
                                                <button type="button" class="btn btn-danger remove-image-btn" data-item-image-id="item-01" data-id="{{ $img1Id }}" data-item-code="{{ $data['item_code'] ?? '' }}" data-image-idx="1" data-image-filename="{{ isset($images['image1']['filepath']) ? basename($images['image1']['filepath']) : '' }}">
                                        ...
                                        <div class="img-cont {{ $img2Actual }}" style="margin-bottom: 20px !important;" id="item-02-actual">
                                            ...
                                            <div class="custom-overlay"></div>
                                            <div class="custom-hover-button">
                                                <button type="button" class="btn btn-danger remove-image-btn" data-item-image-id="item-02" data-id="{{ $img2Id }}" data-item-code="{{ $data['item_code'] ?? '' }}" data-image-idx="2" data-image-filename="{{ isset($images['image2']['filepath']) ? basename($images['image2']['filepath']) : '' }}">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="img-cont {{ $img3Actual }}" style="margin-bottom: 20px !important;" id="item-03-actual">
                                            ...
                                            <div class="custom-overlay"></div>
                                            <div class="custom-hover-button">
                                                <button type="button" class="btn btn-danger remove-image-btn" data-item-image-id="item-03" data-id="{{ $img3Id }}" data-item-code="{{ $data['item_code'] ?? '' }}" data-image-idx="3" data-image-filename="{{ isset($images['image3']['filepath']) ? basename($images['image3']['filepath']) : '' }}">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div style="border-top: 2px solid #1C2833; padding-left: 20px !important; padding-right: 20px !important; line-height: 23px;">
                        <div class="left-container">
                            <div style="width: 55%; display: inline-block; float: left;">
                                <img src="{{ Storage::disk('upcloud')->url('/logo/fumaco-transparent.png') }}" width="100%" style="margin-top: 30px !important;">
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="text-center mt-4" style="min-height: 200px;">
                                                <img src="{{ Storage::disk('upcloud')->url('icon/no-img.png') }}" width="230" class="img-thumbnail mb-3 d-none" id="img-preview">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function (){
        ...
        $(document).on('change', '#browse-file', function (e) {
            ...
            if (!file) {
                ...
                $('#img-preview').addClass('d-none').attr('src', '{{ Storage::disk('upcloud')->url('icon/no-img.png') }}');
