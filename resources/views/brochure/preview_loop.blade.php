                                    ...
                                    @for($img = 1; $img <= 3; $img++)
                                        ...
                                        <div class="img-cont {{ $img_actual }}" style="margin-bottom: 20px !important;" id="{{ $item['item_code'] }}-0{{ $img }}-actual">
                                            ...
                                            <div class="custom-hover-button">
                                                <button type="button" class="btn btn-danger remove-image-btn" data-item-image-id="{{ $item['item_code'] }}-0{{ $img }}" data-id="{{ $img_id }}" data-item-code="{{ $item['item_code'] }}" data-image-idx="{{ $img }}" data-image-filename="{{ isset($item['images']['image'.$img]['filepath']) ? basename($item['images']['image'.$img]['filepath']) : '' }}">
