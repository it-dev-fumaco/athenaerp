                            ...
                            @if ($genericManuals)
                                ...
                                <ul class="list-group list-group-flush">
                                    @foreach ($genericManuals as $manual)
                                        <li class="list-group-item p-2"><a href="{{ Storage::disk('upcloud')->url('user-manual-images/'.$manual) }}" class="text-dark" target="_blank"><i class="fas fa-angle-right"></i> {{ $manual }}</a></li>
                                    @endforeach
                                </ul>
                            @endif
